...
void testGraphsWithAdjacencyList() {
  ...
  /*
  ** Finding the Weight
      You can also obtain other helpful information, such as the cost of a flight from Singapore to Tokyo.
      This is the weight of the edge between those two vertices.
   */
...
void testGraphsWithAdjacencyMatrix() {
